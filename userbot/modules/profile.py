...
async def set_profilherlock(propic):
    """ .profilherlock komutu Telegram'daki profil resminizi yanıtladığınız resimle değişir. """
...
async def remove_profilherlock(delpfp):
