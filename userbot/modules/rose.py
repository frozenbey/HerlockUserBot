...
async def fstat(event):
    ...
    if event.pattern_match.group(1):
        herlock = event.pattern_match.group(1)
    else:
        herlock = ""
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedstat " + kullanıcı + " " + herlock)
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedstat " + herlock)
                fedstat = await conv.get_response()
                if "file" in fedstat.text:
                    await fedstat.click(0)
                    reply = await conv.get_response()
...
async def info(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/info " + herlock)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fedinfo(event):
    if event.fwd_from:
        return
    herlock = event.pattern_match.group(1)
    if herlock == "" and not event.reply_to_msg_id:
        async with event.client.conversation(chat) as conv:
            try:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fedinfo " + herlock)
                fedinfo = await conv.get_response()
                await event.client.forward_messages(event.chat_id, fedinfo)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fban(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fban " + herlock)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def unfban(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/unfban " + herlock)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
...
async def fpromode(event):
    ...
    if event.reply_to_msg_id:
        ...
        async with event.client.conversation(chat) as conv:
            try:
                await conv.send_message("/fpromode " + herlock)
                audio = await conv.get_response()
                await event.client.forward_messages(event.chat_id, audio)
                await event.delete()
                await event.client.send_read_acknowledge(conv.chat_id)
